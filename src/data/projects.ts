...
export const projects: Project[] = [
  {
    ...
    description: 'Automated AWS infrastructure deployment across multiple accounts using Terraform and CI/CD pipelines.',
  ...
  },
  {
    ...
    description: 'Implemented GitOps workflow with ArgoCD and Jenkins for continuous deployment to Kubernetes.',
  ...
  },
  {
    ...
    description: 'Tool to analyze and optimize AWS cloud costs using Lambda functions and DynamoDB.',
  ...
  },
  {
    ...
    description: 'Custom framework for managing infrastructure as code with version control and testing.',
  ...
  },
  {
    ...
    description: 'Security scanner for container images and Kubernetes manifests with CI integration.',
