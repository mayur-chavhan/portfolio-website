...
export const timelineItems: TimelineItem[] = [
  {
    ...
    description:
      'Leading DevOps initiatives and cloud architecture for enterprise clients.',
  ...
  },
  {
    ...
    description:
      'Managed cloud infrastructure and CI/CD pipelines for SaaS products.',
  ...
  },
  {
    ...
    description:
      'Managed on-premises infrastructure and led cloud migration initiatives.',
